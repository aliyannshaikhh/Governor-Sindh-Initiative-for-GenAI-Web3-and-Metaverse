...
var famous_person = "Adele Adkins";
var message = "".concat(famous_person, " once said, \"The greatest gift we can give ourselves is the permission to fully embrace our authentic selves.\"");
console.log(message);
