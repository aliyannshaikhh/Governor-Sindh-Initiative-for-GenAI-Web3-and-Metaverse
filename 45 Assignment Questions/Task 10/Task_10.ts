...
//Task No. 7 performs 4 Arithmetic Operations.
...
//Task No. 9 reveals my favorite number.

var favorite_number:number = 6; //6 is my favorite number since my name contains six letters in it.

let message:string = `${favorite_number} is my favorite number`;
